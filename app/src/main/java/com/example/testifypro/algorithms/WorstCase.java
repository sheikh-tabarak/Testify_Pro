...
public class WorstCase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worst_case);
        getSupportActionBar().setTitle("Worst Case Testing");
                        ...
                        if(
                                            ...
                                            !TextUtils.isEmpty(upperValue2.getText().toString()))
                            {
                                ...
                                )
                                {
                                    ...
                                    Answercontent.setText(Answercontent.getText().toString() + "No, of Combinations = 5 ^ n\n[ n = 2 ]\nNo, of Combinations = 5 ^ 2\nNo, of Combinations = 25");
                                    ...
                                    variables1.setText("( " + a1 + "," + b1 + "," + c1 + "," + d1 + "," + e1 + " )");
                                    ...
                                    variables2.setText("( " + a2 + "," + b2 + "," + c2 + "," + d2 + "," + e2 + " )");

                                    int FirstVariableValues[] ={a1,b1,c1,d1,e1};
                                    int SecondVariableValues[] ={a2,b2,c2,d2,e2};
...
//                                            }
                                    ...
                                    //  finalanswer.setText(finalanswer.getText().toString() + "Variables = 2\nTotal Combination = 9\n\n");


                                    Answercontent.setText("");
                                    Answercontent.setText(Answercontent.getText().toString() + "No, of Combinations = 5 ^ n\n[ n = 3 ]\nNo, of Combinations = 5 ^ 3\nNo, of Combinations = 125");
                                    //     Answercontent.setText(Answercontent.getText().toString() + "Variables = 2\nTotal Combination = 9\n");
                                    ...
                                    variables3.setText("( " + a3 + "," + b3 + "," + c3 + "," + d3 + "," + e3 + " )");



                                    int FirstVariableValues[] ={a1,b1,c1,d1,e1};
                                    int SecondVariableValues[] ={a2,b2,c2,d2,e2};
                                    int ThirdVariableValues[] ={a3,b3,c3,d3,e3};
