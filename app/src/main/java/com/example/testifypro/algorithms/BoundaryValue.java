...
public class BoundaryValue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boundary_value);

        getSupportActionBar().setTitle("Boundary Value Testing");
                        ...
                        if(
                                            ...
                                            !TextUtils.isEmpty(upperValue2.getText().toString()))
                            {
                                ...
                                )
                                {
                                    ...
                                    Answercontent.setText(Answercontent.getText().toString() + "No, of Combinations = 4 ( n ) + 1\n[ n = 2 ]\nNo, of Combinations = 4 ( 2 ) + 1\nNo, of Combinations = 8 + 1\nNo, of Combinations = 9\n");
